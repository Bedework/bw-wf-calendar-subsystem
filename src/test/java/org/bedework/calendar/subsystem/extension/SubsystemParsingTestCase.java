...
public class SubsystemParsingTestCase extends AbstractSubsystemTest {
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml =
                "<subsystem xmlns=\"" + CalendarExtension.NAMESPACE + "\">" +
                        "   <deployment-types>" +
        ...
        Assert.assertEquals(CalendarExtension.SUBSYSTEM_NAME, element.getValue());
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(CalendarExtension.SUBSYSTEM_NAME));
        Assert.assertTrue(model.get(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME).hasDefined("type"));
        Assert.assertTrue(model.get(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME, "type").hasDefined("tst"));
        Assert.assertTrue(model.get(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME, "type", "tst").hasDefined("tick"));
        Assert.assertEquals(12345, model.get(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME, "type", "tst", "tick").asLong());
    }
    ...
    public void testDescribeHandler() throws Exception {
        ...
        describeOp.get(OP_ADDR).set(
                PathAddress.pathAddress(
                        PathElement.pathElement(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME)).toModelNode());
    ...
    public void testSubsystemRemoval() throws Exception {
        ...
        services.getContainer().getRequiredService(CalendarService.createServiceName("tst"));
    ...
    public void testExecuteOperations() throws Exception {
        ...
        PathAddress fooTypeAddr = PathAddress.pathAddress(
                PathElement.pathElement(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME),
        ...
        Assert.assertTrue(model.get(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME, "type").hasDefined("foo"));
        Assert.assertTrue(model.get(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME, "type", "foo").hasDefined("tick"));
        Assert.assertEquals(1000, model.get(SUBSYSTEM, CalendarExtension.SUBSYSTEM_NAME, "type", "foo", "tick").asLong());
        ...
        CalendarService service = (CalendarService) services.getContainer().getService(CalendarService.createServiceName("foo")).getValue();
