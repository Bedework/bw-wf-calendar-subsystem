...
public class CalendarExtension implements Extension {

    /**
     * The name space used for the {@code subsystem} element
     */
    public static final String NAMESPACE = "urn:org.bedework.calendar:1.0";

    /**
     * The name of our subsystem within the model.
     */
    public static final String SUBSYSTEM_NAME = "calendar";
    ...
    private static final String RESOURCE_NAME =
            CalendarExtension.class.getPackage().getName() + ".LocalDescriptions";
    ...
    static StandardResourceDescriptionResolver getResourceDescriptionResolver(final String keyPrefix) {
        ...
        return new StandardResourceDescriptionResolver(
                prefix,
                RESOURCE_NAME,
                CalendarExtension.class.getClassLoader(),
                true,
                false);
    }
    ...
    public void initialize(final ExtensionContext context) {
        ...
        final ManagementResourceRegistration registration =
                subsystem.registerSubsystemModel(
                        CalendarSubsystemDefinition.INSTANCE);
    ...
    private static class SubsystemParser implements XMLStreamConstants, XMLElementReader<List<ModelNode>>, XMLElementWriter<SubsystemMarshallingContext> {
        ...
        public void writeContent(final XMLExtendedStreamWriter writer, final SubsystemMarshallingContext context) throws XMLStreamException {
            ...
            context.startSubsystemElement(CalendarExtension.NAMESPACE, false);
